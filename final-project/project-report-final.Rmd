...
```{r}
# FOR KRIS: INPUT STRAIN CODE HERE
```

```{r NAMEOFOBJECT, fig.cap = "Strain Trajectories from the Aqueduct on April 19th, 2019"}
grid.arrange(NAMEOFOBJECT, nrow=1)
