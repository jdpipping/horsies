...
horse_data <- read_csv("horse-data/processed-data/tracking_data_cleaned.csv")
...
# write csv
write_csv(final_horse_strains, 'horse-data/processed-data/final_horse_strains.csv')